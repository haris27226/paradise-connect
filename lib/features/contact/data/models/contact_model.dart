...
class ContactModel extends Contact {
  ...
  factory ContactModel.fromJson(Map<String, dynamic> json) {
    return ContactModel(
      ...
      salesChannelId: json['sales_channel_id'] != null ? int.tryParse(json['sales_channel_id'].toString()) : null,
      ...
      salesExecutiveId: json['sales_executive_id'] != null ? int.tryParse(json['sales_executive_id'].toString()) : null,
      salesSupervisorId: json['sales_supervisor_id'] != null ? int.tryParse(json['sales_supervisor_id'].toString()) : null,
      salesManagerId: json['sales_manager_id'] != null ? int.tryParse(json['sales_manager_id'].toString()) : null,
      salesTeamId: json['sales_team_id'] != null ? int.tryParse(json['sales_team_id'].toString()) : null,
      statusProspectId: json['status_prospect_id'] != null ? int.tryParse(json['status_prospect_id'].toString()) : null,
      ...
      propertiesJson: json['properties_json']?.toString(),
