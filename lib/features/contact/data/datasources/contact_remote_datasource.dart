...
//       throw Exception(_getErrorMessage(e, 'Failed to load contacts'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load contact details'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load activities'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed create visit'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to create activity'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'An error occurred'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load prospect statuses'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load contact properties'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to delete contact'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load attachment types'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to upload attachment'));
//     }
//   }
...
//     }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to load attachments'));
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       throw Exception(_getErrorMessage(e, 'Failed to delete attachment'));
//     }
//   }
...
class ContactRemoteDataSourceImpl implements ContactRemoteDataSource {
  ...
  Future<void> createContact(CreateContactParams params) async {
    try {
      ...
      throw Exception(_getErrorMessage(e, 'Failed to create contact'));
    }
  }
  ...
  Future<void> updateContact(int id, CreateContactParams params) async {
    try {
      ...
      throw Exception(_getErrorMessage(e, 'Failed to update contact'));
    }
  }
  ...
  Future<void> updateAttachment({required int contactId, required int attachmentId, required UploadAttachmentParams params}) async {
    try {
      ...
      throw Exception(_getErrorMessage(e, 'Failed to update attachment'));
    }
  }
}