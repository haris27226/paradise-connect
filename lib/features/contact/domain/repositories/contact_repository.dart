...
abstract class ContactRepository {
  Future<Either<String, ContactResponse>> getContacts({  int page = 1,  int perPage = 10,  String? search,  String? startDate,  String? endDate,  int? ownerId,  int? statusProspectId,});
  Future<Either<String, Contact>> getContactDetail(int id);
  Future<Either<String, List<Owner>>> getOwners({String search, int page});
  Future<Either<String, List<ProspectStatus>>> getProspectStatuses();
  Future<Either<String, List<SalesExecutive>>> getSalesExecutives({String search, int page});
  Future<Either<String, List<SalesManager>>> getSalesManagers({String search, int page});
