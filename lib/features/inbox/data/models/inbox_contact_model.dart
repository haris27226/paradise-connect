...
class InboxContactModel extends InboxContact {
  InboxContactModel({
    ...
    required super.sessionCode,
    super.unreadCount = 0,
    super.crmContactName,
    super.lastMessageReceiver,
  ...
  factory InboxContactModel.fromJson(Map<String, dynamic> json) {
    return InboxContactModel(
      ...
      isGroup: json["isGroup"] ?? false,
      initials: json["initials"] ?? "",
      lastConversationDate: json["last_conversation_datetime"],
      ownerName: json["owner_name"],
      sessionCode: json["session_code"] ?? "",
      unreadCount: json["unread_count"] ?? 0,
      crmContactName: json["crm_contact_name"],
      lastMessageReceiver: json["last_message_receiver"],
